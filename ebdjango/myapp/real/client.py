...
from real.constants import *
from real.helpers import *
...
class Client(object):
    ...
    '''
    def _build_headers(self, scope, method, timestamp, params={}):
        headers = {
        ...
        if scope.lower() == 'private':
            if method.upper() in ['GET', 'DELETE']:
                params = {'identity': self._api_account, 'nonce': timestamp}
    ...
    #def _build_payload(self, params={}):
    #    return base64.urlsafe_b64encode(JsonResponse(params)
    ...
    def _send_request(self, scope, method, endpoint, params={}):
        ...
        if 'timestamp' in params:
            headers = self._build_headers(scope, method, params['timestamp'])
        else:
            headers = self._build_headers(scope, method, get_current_timestamp(),params)
    ...
    def _send_request(self, scope, method, endpoint, params={}):
        ...
        #postdata= urlencode(data).encode('utf8') #進行編碼
